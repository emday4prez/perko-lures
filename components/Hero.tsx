    ...
    <div>
      ...
      >
        ...
        <ParallaxLayer offset={0.999} speed={1}>
          <div className='max-w-7xl z-10 mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between bg-orange-500'>
        ...
        >
          ...
          <div className='bg-gradient-to-tr from-slate-900 via-slate-800 to-slate-700  text-zinc-100'>
            ...
            <p className='pb-8 lg:px-48 md:text-xl px-2 md:px-24'>
              Handcrafted, extra large fishing lures designed to catch the
              biggest freshwater fish. Each lure is carefully crafted to
              perfection, ensuring that it is not only effective but also
              visually appealing to attract the biggest fish. Perko Lures is
              dedicated to providing anglers with the best tools to make their
              fishing experience both exciting and successful.
            </p>
          </div>
        </ParallaxLayer>
